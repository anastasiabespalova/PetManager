...
public struct SlidingTabView : View {
    ...
    public init(selection: Binding<Int>,
                ...
                activeAccentColor: Color = Color.init(red: 93/255, green: 91/255, blue: 198/255), //Color.lightPurple,
                inactiveAccentColor: Color = Color.black.opacity(0.4),
                selectionBarColor: Color = Color.init(red: 93/255, green: 91/255, blue: 198/255), //Color.lightPurple,
    ...
    var body: some View {
        VStack(alignment: .leading) {
            SlidingTabView(selection: self.$selectedTabIndex,
                           tabs: ["First", "Second"],
                           font: .body,
                           activeAccentColor: Color.lightPurple,
                           selectionBarColor: Color.lightPurple)

                ...
                ScrollView {
                    VStack {
                        ...
                        ForEach(petViewModel.pets[petIndex].active_activities_array.indices, id: \.self){index in
                           // if index < petViewModel.pets[petIndex].active_activities_array.count {
                                // Card View...
                                ZStack {
                                    Color.red
                                        .cornerRadius(20)
                                    ...
                                    HStack {
                                        ...
                                        Button(action: {
                                            ...
                                            if petViewModel.archivingIndex >= 0 {
                                                petViewModel.archiveActivityWithId(petIndex: petIndex, id: petViewModel.archivingIndex)
                                        ...
                                        Button(action: {
                                            petViewModel.deletingIndex = petIndex
                                            petViewModel.deletingActivityTitle = petViewModel.pets[petIndex].active_activities_array[index].title
                  ...
                  .popup(isPresented: $showDeletionPopup, type: .`default`, closeOnTap: false) {
                    DeletePopup(deletedObject: "\(selectedActivity.title) activity", showingPopup: $showDeletionPopup, object: "Activity")
